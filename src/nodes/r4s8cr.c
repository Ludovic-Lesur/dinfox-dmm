...
static const NODE_line_data_t R4S8CR_LINE_DATA[R4S8CR_LINE_DATA_INDEX_LAST] = {
	{"RELAY 1 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, R4S8CR_REG_ADDR_STATUS_CONTROL, R4S8CR_REG_STATUS_CONTROL_MASK_R1ST},
	{"RELAY 2 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, R4S8CR_REG_ADDR_STATUS_CONTROL, R4S8CR_REG_STATUS_CONTROL_MASK_R2ST},
	{"RELAY 3 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, R4S8CR_REG_ADDR_STATUS_CONTROL, R4S8CR_REG_STATUS_CONTROL_MASK_R3ST},
	{"RELAY 4 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, R4S8CR_REG_ADDR_STATUS_CONTROL, R4S8CR_REG_STATUS_CONTROL_MASK_R4ST},
	{"RELAY 5 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, R4S8CR_REG_ADDR_STATUS_CONTROL, R4S8CR_REG_STATUS_CONTROL_MASK_R5ST},
	{"RELAY 6 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, R4S8CR_REG_ADDR_STATUS_CONTROL, R4S8CR_REG_STATUS_CONTROL_MASK_R6ST},
	{"RELAY 7 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, R4S8CR_REG_ADDR_STATUS_CONTROL, R4S8CR_REG_STATUS_CONTROL_MASK_R7ST},
	{"RELAY 8 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, R4S8CR_REG_ADDR_STATUS_CONTROL, R4S8CR_REG_STATUS_CONTROL_MASK_R8ST},
};

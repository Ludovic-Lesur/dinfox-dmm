...
static const NODE_line_data_t SM_LINE_DATA[SM_LINE_DATA_INDEX_LAST - COMMON_LINE_DATA_INDEX_LAST] = {
	{"AIN0 =", " V", STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_ANALOG_DATA_1, SM_REG_ANALOG_DATA_1_MASK_VAIN0, SM_REG_ADDR_ANALOG_DATA_1, DINFOX_REG_MASK_NONE},
	{"AIN1 =", " V", STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_ANALOG_DATA_1, SM_REG_ANALOG_DATA_1_MASK_VAIN1, SM_REG_ADDR_ANALOG_DATA_1, DINFOX_REG_MASK_NONE},
	{"AIN2 =", " V", STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_ANALOG_DATA_2, SM_REG_ANALOG_DATA_2_MASK_VAIN2, SM_REG_ADDR_ANALOG_DATA_2, DINFOX_REG_MASK_NONE},
	{"AIN3 =", " V", STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_ANALOG_DATA_2, SM_REG_ANALOG_DATA_2_MASK_VAIN3, SM_REG_ADDR_ANALOG_DATA_2, DINFOX_REG_MASK_NONE},
	{"DIO0 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_DIGITAL_DATA, SM_REG_DIGITAL_DATA_MASK_DIO0, SM_REG_ADDR_DIGITAL_DATA, DINFOX_REG_MASK_NONE},
	{"DIO1 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_DIGITAL_DATA, SM_REG_DIGITAL_DATA_MASK_DIO1, SM_REG_ADDR_DIGITAL_DATA, DINFOX_REG_MASK_NONE},
	{"DIO2 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_DIGITAL_DATA, SM_REG_DIGITAL_DATA_MASK_DIO2, SM_REG_ADDR_DIGITAL_DATA, DINFOX_REG_MASK_NONE},
	{"DIO3 =", STRING_NULL, STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_DIGITAL_DATA, SM_REG_DIGITAL_DATA_MASK_DIO3, SM_REG_ADDR_DIGITAL_DATA, DINFOX_REG_MASK_NONE},
	{"TAMB =", " |C", STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_ANALOG_DATA_3, SM_REG_ANALOG_DATA_3_MASK_TAMB, SM_REG_ADDR_ANALOG_DATA_3, DINFOX_REG_MASK_NONE},
	{"HAMB =", " %",  STRING_FORMAT_DECIMAL, 0, SM_REG_ADDR_ANALOG_DATA_3, SM_REG_ANALOG_DATA_3_MASK_HAMB, SM_REG_ADDR_ANALOG_DATA_3, DINFOX_REG_MASK_NONE}
};

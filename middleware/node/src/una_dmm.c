...
#define UNA_DMM_NODE_SCAN_PERIOD_SECONDS_MIN        (1 * MATH_SECONDS_PER_HOUR)
#define UNA_DMM_NODE_SCAN_PERIOD_SECONDS_DEFAULT    (1 * MATH_SECONDS_PER_DAY)
#define UNA_DMM_NODE_SCAN_PERIOD_SECONDS_MAX        (1 * MATH_SECONDS_PER_MONTH)

#define UNA_DMM_SIGFOX_UL_PERIOD_SECONDS_MIN        (1 * MATH_SECONDS_PER_MINUTE)
#define UNA_DMM_SIGFOX_UL_PERIOD_SECONDS_DEFAULT    (5 * MATH_SECONDS_PER_MINUTE)
#define UNA_DMM_SIGFOX_UL_PERIOD_SECONDS_MAX        (1 * MATH_SECONDS_PER_DAY)

#define UNA_DMM_SIGFOX_DL_PERIOD_SECONDS_MIN        (10 * MATH_SECONDS_PER_MINUTE)
#define UNA_DMM_SIGFOX_DL_PERIOD_SECONDS_DEFAULT    (6 * MATH_SECONDS_PER_HOUR)
#define UNA_DMM_SIGFOX_DL_PERIOD_SECONDS_MAX        (1 * MATH_SECONDS_PER_WEEK)

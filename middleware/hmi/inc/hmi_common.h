...
#define HMI_COMMON_LINE_INDEX(board) \
    ...
    HMI_##board##_LINE_INDEX_MCU_VOLTAGE_MV, \
    HMI_##board##_LINE_INDEX_MCU_TEMPERATURE_DEGREES, \
...
#define HMI_COMMON_LINE \
    ...
    { "VMCU =", HMI_NODE_DATA_TYPE_VOLTAGE, COMMON_REGISTER_ADDRESS_ANALOG_DATA_0, COMMON_REGISTER_ANALOG_DATA_0_MASK_MCU_VOLTAGE, COMMON_REGISTER_ADDRESS_CONTROL_0, UNA_REGISTER_MASK_NONE }, \
    { "TMCU =", HMI_NODE_DATA_TYPE_TEMPERATURE, COMMON_REGISTER_ADDRESS_ANALOG_DATA_0, COMMON_REGISTER_ANALOG_DATA_0_MASK_MCU_TEMPERATURE, COMMON_REGISTER_ADDRESS_CONTROL_0, UNA_REGISTER_MASK_NONE }, \

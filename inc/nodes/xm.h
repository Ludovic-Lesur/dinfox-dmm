 ...
 * \param[in]	reg_error_value: Value to set in case of node access error.
 ...
 * \param[out]	node_reg: Pointer to the node registers where to store the values.
 * \retval		Function execution status.
 *******************************************************************/
NODE_status_t XM_read_registers(NODE_address_t node_addr, XM_registers_list_t* reg_list, XM_node_registers_t* node_reg);

/*!******************************************************************
 * \fn NODE_status_t XM_reset_registers(XM_registers_list_t* reg_list, XM_node_registers_t* node_reg)
 * \brief Reset a list of registers
 * \param[in]	reg_list: List of registers to reset.
 * \param[out]	node_reg: Pointer to the node registers to reset.
 * \retval		Function execution status.
 *******************************************************************/

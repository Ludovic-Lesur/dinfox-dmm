...
#define ADC_CHANNEL_RS485_BUS_VOLTAGE   ADC_CHANNEL_IN6
#define ADC_CHANNEL_HMI_VOLTAGE         ADC_CHANNEL_IN4
#define ADC_CHANNEL_USB_VOLTAGE         ADC_CHANNEL_IN1

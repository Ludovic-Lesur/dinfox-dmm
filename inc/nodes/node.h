...
NODE_status_t NODE_get_last_register_address(RS485_node_t* node, uint8_t* last_register_address);
NODE_status_t NODE_read_register(RS485_node_t* node, uint8_t register_address, int32_t* value);

...
static const STRING_format_t DMM_REGISTER_FORMAT[DMM_NUMBER_OF_SPECIFIC_REGISTERS] = {
...
static const uint32_t DMM_REGISTER_WRITE_TIMEOUT_MS[DMM_NUMBER_OF_SPECIFIC_REGISTERS] = {

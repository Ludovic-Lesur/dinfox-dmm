...
typedef enum {
    ...
    HMI_BPSM_LINE_INDEX_SOURCE_VOLTAGE,
    HMI_BPSM_LINE_INDEX_STORAGE_VOLTAGE,
    HMI_BPSM_LINE_INDEX_BACKUP_VOLTAGE,
    HMI_BPSM_LINE_INDEX_CHARGE_CONTROL_STATE,
    HMI_BPSM_LINE_INDEX_CHARGE_STATUS,
    HMI_BPSM_LINE_INDEX_BACKUP_CONTROL_STATE,

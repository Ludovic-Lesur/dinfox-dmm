...
#define SM_SIGFOX_UL_PAYLOAD_SENSOR_1_SIZE		9
#define SM_SIGFOX_UL_PAYLOAD_SENSOR_2_SIZE		5
...
/*******************************************************************/
typedef enum {
	SM_SIGFOX_UL_PAYLOAD_TYPE_SENSOR_1 = 0,
	SM_SIGFOX_UL_PAYLOAD_TYPE_SENSOR_2,
	SM_SIGFOX_UL_PAYLOAD_TYPE_LAST
} SM_sigfox_ul_payload_type_t;

/*******************************************************************/
typedef union {
	uint8_t frame[SM_SIGFOX_UL_PAYLOAD_SENSOR_1_SIZE];
	struct {
		unsigned ain0 : 16;
		unsigned ain1 : 16;
		unsigned ain2 : 16;
...
} SM_sigfox_ul_payload_sensor_1_t;

/*******************************************************************/
typedef union {
	uint8_t frame[SM_SIGFOX_UL_PAYLOAD_SENSOR_2_SIZE];
	struct {
		unsigned vmcu : 16;
		unsigned tmcu : 8;
		unsigned tamb : 8;
...
} SM_sigfox_ul_payload_sensor_2_t;
...
static const uint8_t SM_REG_LIST_SIGFOX_UL_PAYLOAD_SENSOR_1[] = {
	SM_REG_ADDR_ANALOG_DATA_1,
	SM_REG_ADDR_ANALOG_DATA_2,
	SM_REG_ADDR_DIGITAL_DATA
};

static const uint8_t SM_REG_LIST_SIGFOX_UL_PAYLOAD_SENSOR_2[] = {
...
static const SM_sigfox_ul_payload_type_t SM_SIGFOX_UL_PAYLOAD_PATTERN[] = {
	SM_SIGFOX_UL_PAYLOAD_TYPE_SENSOR_1,
	SM_SIGFOX_UL_PAYLOAD_TYPE_SENSOR_2
};
...
NODE_status_t SM_build_sigfox_ul_payload(NODE_ul_payload_t* node_ul_payload) {
	...
	SM_sigfox_ul_payload_sensor_1_t sigfox_ul_payload_sensor_1;
	SM_sigfox_ul_payload_sensor_2_t sigfox_ul_payload_sensor_2;
	...
	do {
		...
		case SM_SIGFOX_UL_PAYLOAD_TYPE_SENSOR_1:
			...
			reg_list.addr_list = (uint8_t*) SM_REG_LIST_SIGFOX_UL_PAYLOAD_SENSOR_1;
			reg_list.size = sizeof(SM_REG_LIST_SIGFOX_UL_PAYLOAD_SENSOR_1);
			// Reset registers.
			...
			// Build data payload.
			sigfox_ul_payload_sensor_1.ain0 = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_ANALOG_DATA_1], SM_REG_ANALOG_DATA_1_MASK_VAIN0);
			sigfox_ul_payload_sensor_1.ain1 = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_ANALOG_DATA_1], SM_REG_ANALOG_DATA_1_MASK_VAIN1);
			sigfox_ul_payload_sensor_1.ain2 = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_ANALOG_DATA_2], SM_REG_ANALOG_DATA_2_MASK_VAIN2);
			sigfox_ul_payload_sensor_1.ain3 = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_ANALOG_DATA_2], SM_REG_ANALOG_DATA_2_MASK_VAIN3);
			sigfox_ul_payload_sensor_1.dio0 = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_DIGITAL_DATA], SM_REG_DIGITAL_DATA_MASK_DIO0);
			sigfox_ul_payload_sensor_1.dio1 = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_DIGITAL_DATA], SM_REG_DIGITAL_DATA_MASK_DIO1);
			sigfox_ul_payload_sensor_1.dio2 = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_DIGITAL_DATA], SM_REG_DIGITAL_DATA_MASK_DIO2);
			sigfox_ul_payload_sensor_1.dio3 = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_DIGITAL_DATA], SM_REG_DIGITAL_DATA_MASK_DIO3);
			// Copy payload.
			for (idx=0 ; idx<SM_SIGFOX_UL_PAYLOAD_SENSOR_1_SIZE ; idx++) {
				(node_ul_payload -> ul_payload)[idx] = sigfox_ul_payload_sensor_1.frame[idx];
			}
			(*(node_ul_payload -> size)) = SM_SIGFOX_UL_PAYLOAD_SENSOR_1_SIZE;
			break;
		case SM_SIGFOX_UL_PAYLOAD_TYPE_SENSOR_2:
			// Check compilation flags.
			if ((reg_configuration & SM_REG_CONFIGURATION_MASK_DIGF) == 0) break;
			// Build registers list.
			reg_list.addr_list = (uint8_t*) SM_REG_LIST_SIGFOX_UL_PAYLOAD_SENSOR_2;
			reg_list.size = sizeof(SM_REG_LIST_SIGFOX_UL_PAYLOAD_SENSOR_2);
			// Reset registers.
			status = XM_reset_registers(&reg_list, &node_reg);
			if (status != NODE_SUCCESS) goto errors;
			// Perform measurements.
			...
			sigfox_ul_payload_sensor_2.vmcu = DINFOX_read_field(SM_REGISTERS[COMMON_REG_ADDR_ANALOG_DATA_0], COMMON_REG_ANALOG_DATA_0_MASK_VMCU);
			sigfox_ul_payload_sensor_2.tmcu = DINFOX_read_field(SM_REGISTERS[COMMON_REG_ADDR_ANALOG_DATA_0], COMMON_REG_ANALOG_DATA_0_MASK_TMCU);
			sigfox_ul_payload_sensor_2.tamb = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_ANALOG_DATA_3], SM_REG_ANALOG_DATA_3_MASK_TAMB);
			sigfox_ul_payload_sensor_2.hamb = DINFOX_read_field(SM_REGISTERS[SM_REG_ADDR_ANALOG_DATA_3], SM_REG_ANALOG_DATA_3_MASK_HAMB);
			// Copy payload.
			for (idx=0 ; idx<SM_SIGFOX_UL_PAYLOAD_SENSOR_2_SIZE ; idx++) {
				(node_ul_payload -> ul_payload)[idx] = sigfox_ul_payload_sensor_2.frame[idx];
			}
			(*(node_ul_payload -> size)) = SM_SIGFOX_UL_PAYLOAD_SENSOR_2_SIZE;
			break;
		default:

...
typedef enum {
	...
	HMI_ERROR_BASE_RTC = (HMI_ERROR_BASE_LPUART + LPUART_ERROR_BASE_LAST),
	HMI_ERROR_BASE_STRING = (HMI_ERROR_BASE_RTC + RTC_ERROR_BASE_LAST),
	HMI_ERROR_BASE_RS485 = (HMI_ERROR_BASE_STRING + STRING_ERROR_BASE_LAST),
	HMI_ERROR_BASE_SH1106 = (HMI_ERROR_BASE_RS485 + RS485_ERROR_BASE_LAST),

...
typedef enum {
	...
	DINFOX_NODE_ADDRESS_LVRM_START =(DINFOX_NODE_ADDRESS_MPMCM_START + DINFOX_NODE_ADDRESS_RANGE_MPMCM),
	DINFOX_NODE_ADDRESS_DDRM_START = (DINFOX_NODE_ADDRESS_LVRM_START + DINFOX_NODE_ADDRESS_RANGE_LVRM),
	DINFOX_NODE_ADDRESS_LBUS_LAST = (DINFOX_NODE_ADDRESS_DDRM_START + DINFOX_NODE_ADDRESS_RANGE_DDRM),
...
static const STRING_format_t DINFOX_REGISTER_FORMAT[DINFOX_REGISTER_LAST] = {
...
static const uint32_t DINFOX_REGISTER_WRITE_TIMEOUT_MS[DINFOX_REGISTER_LAST] = {

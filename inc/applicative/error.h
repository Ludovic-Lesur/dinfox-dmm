...
typedef enum {
	...
	ERROR_BASE_TIM3 = (ERROR_BASE_TIM2 + TIM_ERROR_BASE_LAST),
	ERROR_BASE_TIM21 = (ERROR_BASE_TIM3 + TIM_ERROR_BASE_LAST),
	ERROR_BASE_TIM22 = (ERROR_BASE_TIM21 + TIM_ERROR_BASE_LAST),
	// Utils.
	ERROR_BASE_MATH = (ERROR_BASE_TIM22 + TIM_ERROR_BASE_LAST),
